(defsystem "apeiron-test"
  ...
  :author "Sophia"
  :license "MIT"
  :depends-on ("apeiron" "fiveam" "fset")
  :components ((:module "tests"
                ...
                ((:file "test-package")
                 ...
                 (:file "core/test-equipment" :depends-on ("test-package"))
                 ...
                 (:file "core/test-command-handler" :depends-on ("test-package"))
                 ...
                 (:file "server/test-main" :depends-on ("test-package"))
